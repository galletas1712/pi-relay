// Copied verbatim from prime-agent (repos/prime-agent/packages/coding-agent/src/core/kernel/state-snapshot.ts) for M3 RLM-semantics parity; only this provenance comment was added.
