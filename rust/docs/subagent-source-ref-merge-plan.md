...
> subagent's final-message preview + full transcript, with full final messages
> available as files) plus a typed daemon wakeup observation pointing the parent
