...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@pi-relay/coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@pi-relay/coding-agent?style=flat-square" /></a>
  <a href="https://github.com/galletas1712/pi-relay/actions/workflows/ci.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/galletas1712/pi-relay/ci.yml?style=flat-square&branch=main" /></a>
</p>
<p align="center">
...
```bash
npm install -g @pi-relay/coding-agent
```
...
Place in `~/.pi/agent/extensions/`, `.pi/extensions/`, or a [pi package](#pi-packages) to share with others. See [docs/extensions.md](docs/extensions.md) and [`@pi-relay/extensions` examples](../extensions/examples/).
...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@pi-relay/coding-agent";
...
See [src/client/rpc/wire.ts](src/client/rpc/wire.ts) for the protocol.
...
| `--mode rpc` | RPC mode for process integration (see [src/client/rpc/wire.ts](src/client/rpc/wire.ts)) |
...
- [@pi-relay/ai](https://www.npmjs.com/package/@pi-relay/ai): Core LLM toolkit
- [@mariozechner/pi-agent](https://www.npmjs.com/package/@mariozechner/pi-agent): Agent framework
- [@pi-relay/tui](https://www.npmjs.com/package/@pi-relay/tui): Terminal UI components
