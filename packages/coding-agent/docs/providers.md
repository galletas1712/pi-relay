...
**Via extensions:** For providers that need custom API implementations or OAuth flows, create an extension. See [custom-provider.md](custom-provider.md) and [extensions/examples/custom-provider-gitlab-duo](../../extensions/examples/custom-provider-gitlab-duo/).
