...
**Source:** [`@pi-relay/tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@pi-relay/tui";
...
```typescript
import { Container, type Focusable, Input } from "@pi-relay/tui";
...
See [overlay-qa-tests.ts](../../extensions/examples/overlay-qa-tests.ts) for comprehensive examples covering anchors, margins, stacking, responsive visibility, and animation.

## Built-in Components

Import from `@pi-relay/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@pi-relay/tui";
```
...
```typescript
import { matchesKey, Key } from "@pi-relay/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@pi-relay/tui";
...
```typescript
import { getMarkdownTheme } from "@pi-relay/coding-agent";
import { Markdown } from "@pi-relay/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@pi-relay/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@pi-relay/coding-agent";
import { DynamicBorder } from "@pi-relay/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@pi-relay/tui";
...
**Examples:** [preset.ts](../../extensions/examples/preset.ts), [tools.ts](../../extensions/examples/tools.ts)
...
```typescript
import { BorderedLoader } from "@pi-relay/coding-agent";
...
**Examples:** [qna.ts](../../extensions/examples/qna.ts), [handoff.ts](../../extensions/examples/handoff.ts)

### Pattern 3: Settings/Toggles (SettingsList)

For toggling multiple settings. Use `SettingsList` from `@pi-relay/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@pi-relay/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@pi-relay/tui";
...
**Examples:** [tools.ts](../../extensions/examples/tools.ts)
...
**Examples:** [status-line.ts](../../extensions/examples/status-line.ts), [plan-mode/](../../extensions/examples/plan-mode/), [preset.ts](../../extensions/examples/preset.ts)
...
**Examples:** [plan-mode/](../../extensions/examples/plan-mode/)
...
**Examples:** [custom-footer.ts](../../extensions/examples/custom-footer.ts)
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@pi-relay/coding-agent";
import { matchesKey, truncateToWidth } from "@pi-relay/tui";
...
**Examples:** [modal-editor.ts](../../extensions/examples/modal-editor.ts)
...
- **Selection UI**: [extensions/examples/preset.ts](../../extensions/examples/preset.ts) - SelectList with DynamicBorder framing
- **Async with cancel**: [extensions/examples/qna.ts](../../extensions/examples/qna.ts) - BorderedLoader for LLM calls
- **Settings toggles**: [extensions/examples/tools.ts](../../extensions/examples/tools.ts) - SettingsList for tool enable/disable
- **Status indicators**: [extensions/examples/plan-mode/](../../extensions/examples/plan-mode/) - setStatus and setWidget
- **Custom footer**: [extensions/examples/custom-footer.ts](../../extensions/examples/custom-footer.ts) - setFooter with stats
- **Custom editor**: [extensions/examples/modal-editor.ts](../../extensions/examples/modal-editor.ts) - Vim-like modal editing
- **Snake game**: [extensions/examples/snake.ts](../../extensions/examples/snake.ts) - Full game with keyboard input, game loop
- **Custom tool rendering**: [extensions/examples/todo.ts](../../extensions/examples/todo.ts) - renderCall and renderResult
