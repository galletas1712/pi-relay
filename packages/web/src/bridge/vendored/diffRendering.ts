...
// Source: apps/web/src/lib/diffRendering.ts
// Local adaptation: imports come from the @pierre/diffs package root (its exports map does not expose the deep subpaths T3 imports).
