 ...
 *
 * Usage: pi --extension ./packages/extensions/examples/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@pi-relay/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@pi-relay/tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@pi-relay/tui";
