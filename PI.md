...
- Subagent orchestration is not exposed through the regular model tool-use API. If orchestration is needed, use the dedicated orchestration environment when available; otherwise proceed directly.
