...
`inspect_delegation`. When a running subagent needs a correction or more context,
prefer `steer_subagent` over cancelling and restarting. Cancellation is terminal and does not roll back
